...
func (_mock *UserStore) GetUserByEmail(ctx context.Context, email string) (authentication.User, error) {
	...
	var r0 authentication.User
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) (authentication.User, error)); ok {
		return returnFunc(ctx, email)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) authentication.User); ok {
		r0 = returnFunc(ctx, email)
	} else {
		r0 = ret.Get(0).(authentication.User)
	}
...
func (_c *UserStore_GetUserByEmail_Call) Return(user authentication.User, err error) *UserStore_GetUserByEmail_Call {
	_c.Call.Return(user, err)
	return _c
}

func (_c *UserStore_GetUserByEmail_Call) RunAndReturn(run func(ctx context.Context, email string) (authentication.User, error)) *UserStore_GetUserByEmail_Call {
	_c.Call.Return(run)
	return _c
}
